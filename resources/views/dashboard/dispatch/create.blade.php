            ...
            <div class="col-sm-12 col-md-10 col-lg-8 col-xl-12 ">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        {{-- <form id="form_adjudication" method="POST" action="{{ route('dispatch.store') }}" enctype="multipart/form-data"> --}}
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>PIC</label>
                                            <input class="form-control" type="text" name="contact_name" autocomplete="off">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="text" name="send_to">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="courier_id" >
                                                <option value="">--Assign Dispatch--</option>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="datetime-local" name="return_to_office_datetime">
                                        </div>
                                    </div>
                        ...
                        <button class="btn btn-success float-right" type="button" onclick="SaveRecord()" @if ($blnAllowEdit == false) disabled @endif>{{ __('coreuiforms.save') }}</button>
