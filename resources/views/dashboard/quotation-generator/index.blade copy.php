      ...
      <div class="col-sm-12">
        <!-- <div id="quotation_list" class="card">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-12">
                <a class="btn btn-lg btn-primary  float-right" href="javascript:void(0);" onclick="quotationGeneratorMode()">
              ...
              <tbody id="tbl-quotation_">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="javascript:void(0)" onclick="loadQuotation('{{$quotation->id}}');" class="btn btn-primary shadow sharp mr-1" data-toggle="tooltip" data-placement="top" title="Edit"><i class="cil-pencil"></i></a>
