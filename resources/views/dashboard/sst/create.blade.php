                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label" for="transfer_date">Payment Date</label>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label" for="pay_amount">Total SST Paid</label>
                                            <div class="col-md-8">
                                                <input class="form-control" name="pay_amount" id="pay_amount"
                                    ...
                                    <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control" name="branch_sst" id="branch_sst">
                                    ...
                                    <div class="col-sm-12">
                                        <a href="javascript:void(0)" data-backdrop="static" data-keyboard="false"
                                            data-toggle="modal" data-target="#modalTransferFee" class="btn btn-info">Add new SST<i class="cil-zoom"></i> </a>
...
@section('javascript')
    ...
    <script>
        ...
        function saveTransferFee() {
            ...
            if ($("#trx_id").val() == '' || $("#transfer_date").val() == '' || $("#branch_sst").val() == 0) {
        ...
        function reloadAddTable() {
            var table = $('#tbl-transfer-bill-added').DataTable({
                ...
                drawCallback: function(settings) {
                    ...
                    $("#pay_amount").val(monTotal.toFixed(2));
                }
            });
