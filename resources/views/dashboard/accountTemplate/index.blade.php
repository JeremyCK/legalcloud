      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-12">
                <a class="btn btn-lg btn-primary  float-right" href="/account-template/create">
            ...
            <table class="table table-striped table-bordered datatable">
              ...
              <tbody>
                @if(count($account_template))
                @foreach($account_template as $index => $template)
                <tr>
