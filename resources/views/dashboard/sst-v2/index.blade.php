      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-6">
                <h4>SST Payment Record (Invoice Based)</h4>
              </div>

              <div class="col-6">
                <a class="btn btn-lg btn-primary  float-right" href="{{ route('sst-v2.create') }}">
          ...
          <div class="card-body" style="width:100%;overflow-x:auto">
            ...
            @endif
              ...
              <div class="col-sm-12">
                <button type="button" class="btn btn-lg btn-info float-right" onclick="reloadTable();">
