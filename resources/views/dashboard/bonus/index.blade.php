                    ...
                    <div id="dSummaryReport" class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <a href="javascript:void(0)"  data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#modalBonusClaimNotes" class="btn btn-warning float-right"><i class="cil-warning"></i>Important Notice  </a>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <p>
                                ...
                                <ul class="a">
                                    ...
                                    <li> 3. Upon resignation / termination of employment, closed files claim will be forfeited, active files claim will be transferred to next PIC</li>
                            ...
                            <p>
                                ...
                                <ul class="a">
                                    ...
                                    <li> 2. Represented cases (S&P stamped within 21 days from the file opened & upload to LC)</li>
                                    <li> 3. Loan cases (received Bank executed loan docs within 14 days from the S&P Commencement Date & upload to LC our acknowledgement of the letter from bank returning executed docs & letter from SPA solicitor confirm actual CD)</li>
                                </ul>
                            </p>
                            <p>
                                D. 3% claim will be rewarded based on KPI below
                                <ul class="a">
                                    <li> 1. Files must be completed within ACTUAL Completion Date (not extended completion date free of interest)</li>
                                    <li> 2. SPA cases (to upload in LC letter from SPA solicitors confirm actual CD, delivery of keys, BPP released, legal fees all paid & title registered)</li>
                                    <li> 3. Loan cases (to upload in LC letter from SPA solicitors confirm actual CD, all loan sum disbursed, legal fees all paid, title registered & acknowledgement from Bank confirm received original title / agreements)</li>
                                </ul>
                            </p>
                        </div>
...
@section('javascript')
    ...
    <script>
        ...
        function getReport() {
            ...
            $.ajax({
                type: 'POST',
                url: '/getBonusReport/{{ $current_user->id }}',
                // url: '/getBonusReport/17',
                data: form_data,
                processData: false,
                contentType: false,
                success: function(result) {
