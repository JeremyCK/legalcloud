            ...
            <div class="col-sm-12 col-md-10 col-lg-8 col-xl-12 ">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        {{-- <form id="form_adjudication" method="POST" action="{{ route('land-office.store') }}" enctype="multipart/form-data"> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>Matter </label>
                                            <textarea class="form-control" id="matter" name="matter" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <button class="btn btn-success float-right" onclick="SaveRecord()" type="button">{{ __('coreuiforms.save') }}</button>
                        <a href="{{ route('land-office.index') }}" class="btn btn-danger">{{ __('coreuiforms.return') }}</a>
                    </div>
                </div>
            </div>
