...
if(!function_exists('renderDropdown')){
    function renderDropdown($data){
        if(array_key_exists('slug', $data) && $data['slug'] === 'dropdown'){
            ...
            echo $data['name'] . ' <div id="side_' .$data['name'].'"></div></a>';
            ...
            for($i = 0; $i < count($data); $i++){
                if( $data[$i]['slug'] === 'link' ){
                    ...
                    echo '<span class="c-sidebar-nav-icon"></span>' . $data[$i]['name'] . '<div id="side_' .$data[$i]['id'].'"></div></a></li>';
...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/logo-lhyeo.jpeg') }}" width="auto" height="60" alt="CoreUI Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/logo-lhyeo.jpeg') }}" width="118" height="46" alt="CoreUI Logo">
        </div>
