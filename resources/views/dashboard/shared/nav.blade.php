<div class="c-sidebar-brand"><img class="c-sidebar-brand-full" src="/assets/brand/coreui-pro-base-white.svg" width="118" height="46" alt="CoreUI Logo"><img class="c-sidebar-brand-minimized" src="/assets/brand/coreui-signet-white.svg" width="118" height="46" alt="CoreUI Logo"></div>
      <ul class="c-sidebar-nav" data-drodpown-accordion="true">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/colors">
            <svg class="c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
          ...
          <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/buttons/loading-buttons"><span class="c-sidebar-nav-icon"></span> Loading Buttons<span class="badge badge-danger">PRO</span></a></li>
          </ul>
        </li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/charts">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-chart-pie"></use>
            </svg> Charts</a></li>
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-code"></use>
            </svg> Editors</a>
          <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/editors/code-editor">
                <svg class="c-sidebar-nav-icon">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/editors/markdown-editor">
                <svg class="c-sidebar-nav-icon">
                  <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-code"></use>
                </svg> Markdown<span class="badge badge-danger">PRO</span></a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/editors/text-editor">
                <svg class="c-sidebar-nav-icon">
                  <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-notes"></use>
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
          ...
          <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/forms/advanced-forms"><span class="c-sidebar-nav-icon"></span> Advanced<span class="badge badge-danger">PRO</span></a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/forms/validation"><span class="c-sidebar-nav-icon"></span> Validation<span class="badge badge-danger">PRO</span></a></li>
          </ul>
        </li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/google-maps">
            <svg class="c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
          ...
          <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/icons/coreui-icons"><span class="c-sidebar-nav-icon"></span> CoreUI Icons<span class="badge badge-success">Free</span></a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/icons/flags"><span class="c-sidebar-nav-icon"></span> Flags</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/icons/brands"><span class="c-sidebar-nav-icon"></span> Brands</a></li>
          </ul>
        </li>
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
            <svg class="c-sidebar-nav-icon">
          ...
          <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/notifications/toastr"><span class="c-sidebar-nav-icon"></span> Toastr<span class="badge badge-danger">PRO</span></a></li>
          </ul>
        </li>
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
            <svg class="c-sidebar-nav-icon">
          ...
          <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/plugins/calendar">
                <svg class="c-sidebar-nav-icon">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/plugins/draggable-cards">
                <svg class="c-sidebar-nav-icon">
                  <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-cursor-move"></use>
                </svg> Draggable<span class="badge badge-danger">PRO</span></a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/plugins/spinners">
                <svg class="c-sidebar-nav-icon">
                  <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-sync"></use>
                </svg> Spinners<span class="badge badge-danger">PRO</span></a></li>
          </ul>
        </li>
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-columns"></use>
            </svg> Tables</a>
          <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/tables/datatables"><span class="c-sidebar-nav-icon"></span> DataTables<span class="badge badge-danger">PRO</span></a></li>
          </ul>
        </li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/widgets">
            <svg class="c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
          ...
          <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/404" target="_top">
                <svg class="c-sidebar-nav-icon">
                  <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-bug"></use>
                </svg> Error 404</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/500" target="_top">
                <svg class="c-sidebar-nav-icon">
                  <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-bug"></use>
                </svg> Error 500</a></li>
          </ul>
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
          ...
          <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
              ...
              <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/apps/invoicing/invoice"><span class="c-sidebar-nav-icon"></span> Invoice<span class="badge badge-danger">PRO</span></a></li>
              </ul>
            </li>
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="/#">
                <svg class="c-sidebar-nav-icon">
              ...
              <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/apps/email/inbox"><span class="c-sidebar-nav-icon"></span> Inbox<span class="badge badge-danger">PRO</span></a></li>
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/apps/email/message"><span class="c-sidebar-nav-icon"></span> Message<span class="badge badge-danger">PRO</span></a></li>
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/apps/email/compose"><span class="c-sidebar-nav-icon"></span> Compose<span class="badge badge-danger">PRO</span></a></li>
              </ul>
            </li>
          </ul>
        </li>
