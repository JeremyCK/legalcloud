            ...
            <table class="table table-striped table-bordered datatable">
              ...
              <tbody id="tbl-case-bill">
                ...
                <tr>
                  ...
                  <td class="hide"><input class="form-control" type="number" value="{{ $details->min }}" id="quo_min_{{ $details->id }}_ori"></td>
                  ...
                  <td><input class="form-control " onchange="modifiedCheck('{{ $details->id }}')" type="number" value="{{ $details->min }}" id="quo_min_{{ $details->id }}"></td>
