        ...
        @foreach ($rows as $index => $row)
            <tr>
              ...
              <td class="text-right">
                ...
                <td class="text-right">{{ number_format($row->p1_bonus_2_percent, 2, '.', ',') }}</td>
                <td class="text-right">{{ number_format($row->p1_bonus_3_percent, 2, '.', ',') }}</td>
            </tr>
            @php
                $total_staff_bonus_2_per += $row->bonus_2_percent;
                $total_staff_bonus_3_per += $row->bonus_3_percent;
                $total_staff_bonus_2_per_p1 += $row->p1_bonus_2_percent;
                $total_staff_bonus_3_per_p1 += $row->p1_bonus_3_percent;
            @endphp
        @endforeach
