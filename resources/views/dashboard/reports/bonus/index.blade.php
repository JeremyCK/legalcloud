                                ...
                                <table class="table  datatable" style="overflow-x: auto; width:100%">
                                    <thead>
                                        <tr style="background-color: black;color:white">
                                            <th>No</th>
                                            <th>Staff</th>
                                            <th>Approved Bonus (2%)</th>
                                            <th>Approved Bonus (3%)</th>
                                            <th>Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if(count($staffs))
                                            ...
                                            {{-- <tr style="background-color: #d8dbe0"> --}}
                                                <td>{{$index+1}}</td>
                                                <td>{{$staff->name}}</td>
                                                <td class="text-right">{{ number_format($staff->bonus_total_sum_2, 2, '.', ',') }}</td>
                                                <td class="text-right">{{ number_format($staff->bonus_total_sum_3, 2, '.', ',') }}</td>
                                                <td class="text-right">{{ number_format($staff->bonus_total_sum_2 + $staff->bonus_total_sum_3, 2, '.', ',') }}</td>
                                            </tr>
                                            @endforeach
                                        @else
...
@section('javascript')
    ...
    <script>
        ...
        function getReport() {
            ...
            $.ajax({
                type: 'POST',
                url: '/getBonusReport/' + $('#staff_id').val(),
                data: form_data,
                processData: false,
                contentType: false,
                success: function(result) {
