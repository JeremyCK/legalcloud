          ...
          <div class="card-body">
            ...
            <div>
              <div class="div2  printableArea  " style="overflow-x: auto; width:100%">
                ...
                <span style="font-size:20px;font-weight:bold">PAYMENT VOUCHER ISSUED - JANUARY 2018 </span>
                ...
                <table class="table  table-bordered datatable" style="overflow-x: auto; width:100%">
                  <thead>
                    <tr class="text-center">
                      ...
                      <th style="font-size:9px" >Voucher No</th>
                      <th style="font-size:9px" >Case ref No</th>
                      <th style="font-size:9px" >Transaction id</th>
                      <th style="font-size:9px" >Payment Desc</th>
                      <th style="font-size:9px" >Adjuducation No</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-center" style="font-size:9px" >{{  date('d-m-Y', strtotime($voucher->created_at)) }}</td>
                      <td class="text-center" style="font-size:9px" >{{ $voucher->voucher_no }}</td>
                      <td  style="font-size:9px" >{{ $voucher->case_ref_no }}</td>
                      <td class="text-center" style="font-size:9px" >{{ $voucher->transaction_id }}</td>
                      <td  style="font-size:9px" >{{ $voucher->remark }}</td>
                      <td class="text-center" style="font-size:9px" >{{ $voucher->adjudication_no }}</td>
                      <td class="text-center" style="font-size:9px" >{{ $voucher->mileage }}</td>
