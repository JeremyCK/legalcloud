        ...
        <div class="fade-in">
            <div class="row">
                <div class="col-sm-12">
                                ...
                                @if (count($staffCaseCount) > 0)
                                    <div class="row hide">
                                        ...
                                        <div class="col-xl-12 col-md-12 col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <strong class="div_year div_2024">Staff cases report (2024)</strong>
                                                    <strong class="div_year div_2023" style="display: none">Staff cases report (2023)</strong>
                                                    ...
                                                    <a href="javacript:void(0)" id="btn-filter-month"
                                                        onclick="filterDate(2022);"
                                                        class="btn btn-filter-date pull-right ">2022</a>
                                                    <a href="javacript:void(0)" id="btn-filter-week"
                                                        onclick="filterDate(2023);"
                                                        class="btn btn-filter-date pull-right ">2023</a>
                                                    <a href="javacript:void(0)" id="btn-filter-week"
                                                        onclick="filterDate(2024);"
                                                        class="btn btn-filter-date pull-right btn-selected">2024</a>
                                                </div>
                                                ...
                                                <div class="card-body" style="max-height:500px;overflow:scroll">
                                                    ...
                                                    <div class="div_year div_2022" style="display: none">
                                                        <table
                                                            class="table table-responsive-sm table-hover table-bordered mb-0">
                                                    ...
                                                    <div class="div_year div_2023"  style="display: none">
                                                                ...
                                                                @if (count($staffCaseCount))
                                                                    @foreach ($staffCaseCount as $index => $user)
                                                                        <tr>
                                                                            <td class="text-left">
                                                                                {{ $user->name }}<br /><b>Total:
                                                                                </b>{{ $user->total_cases_count_2024 }}</td>

                                                                            @foreach ($user->cases_count_2024 as $index2 => $count)
                                                                                <td class="text-center">
                                                                                    {{ $count }}</td>
                                                                            @endforeach
                                                                        </tr>
                    ...
                    <div  class="card">
                        <div class="card-header">
                            <h4>Staff Cases Report Overview</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-xs-12">
                                    <div id="tbl-lawyer-report" class="  ">

                                    </div>
                                </div>
                                <div class="col-lg-6 col-xs-12">
                                    <div id="tbl-clerk-report" class="  ">
        ...
        function reloadTable2() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $("#tbl-lawyer-report").html(result.view_lawyer);
