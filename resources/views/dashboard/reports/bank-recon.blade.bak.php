        ...
        <div id="dSummaryReport" class="card">
          ...
          <div class="card-body">
            ...
            <div class="row no-print">
              ...
              <div class="col-sm-12">
                <a class="btn btn-lg btn-info  float-right" href="javascript:void(0)" onclick="getMonthRecon()">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label" for="hf-email">Bank Name:</label>
                  <div class="col-md-8">
                    <label class="col-md-4 col-form-label" id="bank_name">-</label>
                  </div>
                </div>

                <div class="form-group row">
                  <label class="col-md-4 col-form-label" for="hf-email">Account No:</label>
                  <div class="col-md-8">
                    <label class="col-md-4 col-form-label" id="account_no">-</label>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label" for="hf-email">Bank Code:</label>
                  <div class="col-md-8">
                    <label class="col-md-4 col-form-label" id="bank_code">-</label>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-md-4 col-form-label" for="hf-email">Account Type:</label>
                  <div class="col-md-8">
                    <label class="col-md-4 col-form-label" id="account_type">-</label>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 ">
                ...
                <table id="tbl-bank-recon-add" class="table  datatable" style="overflow-x: auto; width:100%"></table>
                <hr />
                <h4 class="text-left">Less Cleared Cheques</h4>
                <table id="tbl-bank-recon-less" class="table  datatable" style="overflow-x: auto; width:100%"></table>
                <hr />
...
<script>
  ...
  function getMonthRecon() {
    ...
    form_data.append("month", 7);
    form_data.append("year", 2022);
