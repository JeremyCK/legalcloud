      ...
      <div class="col-sm-12">
        ...
        <div id="dSummaryReport" class="card">
          ...
          <div class="card-body">
            ...
            <br />
            <div>
              <!-- <div id="tbl_all" class="div2  printableArea  " style="overflow-x: auto;overflow-y: auto; width:100%;height:800px;display:none">
                @include('dashboard.report-referral.tbl-referral-report')
              </div> -->
