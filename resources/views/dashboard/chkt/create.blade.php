            ...
            <div class="col-sm-12 col-md-10 col-lg-8 col-xl-12 ">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        {{-- <form id="form_adjudication" method="POST" action="{{ route('chkt.store') }}"  enctype="multipart/form-data"> --}}
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="text" name="case_ref" required>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="date" name="last_spa_date">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="date" name="current_spa_date">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="text" name="chkt_filled_on">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <button onclick="SaveRecord()" class="btn btn-success float-right" type="button">{{ __('coreuiforms.save') }}</button>
