            ...
            <div class="col-8 ">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        {{-- <form id="form_adjudication" method="POST" action="{{ route('chkt.update', $adjudication->id) }}" enctype="multipart/form-data"> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" value="@if($adjudication->case_id== 0) {{$adjudication->case_ref}} @else {{$adjudication->case_ref_no}} @endif " type="text" name="case_ref_no" required>
                                            <input class="form-control" type="hidden" value="{{$adjudication->case_id}}" name="case_id">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>Client</label>
                                            <input class="form-control" type="text" name="client_name" value="{{$adjudication->client_name}}" required>
                                            <input class="form-control" type="hidden" name="client_id" value="{{$adjudication->client_id}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>Last SPA Date</label>
                                            <input class="form-control" type="date" name="last_spa_date" value="{{$adjudication->last_spa_date}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>Current SPA Date</label>
                                            <input class="form-control" type="date" name="current_spa_date" value="{{$adjudication->current_spa_date}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>CHKT Filed On</label>
                                            <input class="form-control" type="text" name="chkt_filled_on"   value="{{$adjudication->chkt_filled_on}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>3% RPGT Paid</label>
                                            <select class="form-control" name="per3_rpgt_paid">
                                                <!-- <option value="0">No</option>
                                                <option value="1">Yes</option> -->
                                                <option value="0" @if($adjudication->per3_rpgt_paid == 0) selected @endif>No</option>
                                                <option value="1" @if($adjudication->per3_rpgt_paid == 1) selected @endif>Yes</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="branch">
                                                ...
                                                <option value="{{$bran->id}}" @if($bran->id == $adjudication->branch) selected @endif >{{$bran->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                {{-- <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>Received Notis Taksiran</label>
                                                ...
                                                <ul class="mailbox-attachments clearfix">
                                                    <li>
                                                        ...
                                                        <div class="mailbox-attachment-info">
                                                            <a target="_blank" href="/app/documents/chkt/{{$adjudication->file_new_name }}" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> {{$adjudication->file_ori_name}}</a>
                        ...
                        <button class="btn btn-success float-right" type="button" onclick="UpdateRecord({{ $adjudication->id }})">{{ __('coreuiforms.save') }}</button>
                        <a href="{{ route('chkt.index') }}" class="btn btn-danger">{{ __('coreuiforms.return') }}</a>
