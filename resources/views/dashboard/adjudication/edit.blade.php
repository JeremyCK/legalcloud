            ...
            <div class="col-sm-12 col-md-10 col-lg-8 col-xl-12 ">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="form_adjudication" method="POST" action="{{ route('adjudication.update', $adjudication->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" value="{{$adjudication->first_house}}" type="text" name="first_house" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" value="{{$adjudication->adju_no}}" type="text" name="adju_no">
                                        </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="date" value="{{$adjudication->notis_date}}" name="notis_date">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>Client</label>
                                            <input class="form-control" type="text" name="client" value="{{$adjudication->client_name}}" required>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="text" name="adju_doc" value="{{$adjudication->adju_doc}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="date" name="adju_date" value="{{$adjudication->adju_date}}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="stamp_duty_paid">
                                                ...
                                                <option value="1" @if($adjudication->stamp_duty_paid == 1) selected @endif>Paid</option>
                                                <option value="2" @if($adjudication->stamp_duty_paid == 2) selected @endif>Exempted</option>
                                            </select>
                                        </div>
                                    </div>
