                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col">
                                                                        <label>Remark</label>
                                                                        <textarea class="form-control" id="desc" name="desc" rows="3">{{ $banks->desc }}</textarea>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col">
                                                                        <label>Fax</label>
                                                                        <input class="form-control" value="{{ $banks->fax }}"  type="text" name="fax" >
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col">
                                                                        <label>Address</label>
                                                                        <textarea class="form-control" id="address" name="address" rows="3">{{ $banks->address }}</textarea>
                                                                    </div>
                                                                </div>
