                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label" for="hf-email">Type</label>
                                            <div class="col-md-8">
                                                <select class="form-control" name="voucher_type" id="voucher_type">
                                                    ...
                                                    <option value="REIMBURSEMENT_SST">Reimbursement SST</option>
                                                    <option value="CLOSEDFILE">Close File</option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <table class="table table-bordered table-striped yajra-datatable" style="width:100%">
                                ...
                                <tfoot  style="background-color: black;color:white">
                                    ...
                                    <th  colspan="8" class="text-left"> </th>
                                </tfoot>
                            </table>
                        </div>
                    </div>
