                        ...
                        <div class="card wizard-card" data-color="red" id="wizard">
                            <form action="{{ route('teams.store') }}" method="POST">
                                ...
                                <div class="wizard-header">
                                    <h3 class="wizard-title">Create new Team</h3>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label"
                                                        for="hf-password">Description</label>
                                                    <div class="col-md-9">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($clerks as $index => $clerk)
                                                            <tr>
                                                                <td>{{ $clerk->name }}</td>
                                                                <td>
                                                                    <input class="" name="assignTo[]" type="checkbox"
                                                                        value="{{ $clerk->id }}">
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                        ...
                                                        @foreach ($sales as $index => $sale)
                                                            <tr>
                                                                <td>{{ $sale->name }}</td>
                                                                <td>
                                                                    <input class="" name="assignTo[]"
                                                                        type="checkbox" value="{{ $sale->id }}">
                                                                </td>
                                                            </tr>
                                                        @endforeach
