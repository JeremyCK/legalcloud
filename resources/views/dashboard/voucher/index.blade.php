                        ...
                        <div class="card">
                            ...
                            <div class="nav-tabs-custom nav-tabs-custom-ctr">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    {{-- <option
                                        ...
                                        {{ $branch->name }}</option> --}}
                                        <li class="nav-item">
                                            <a class="nav-link @if($current_user->branch_id == $not['branch_id']) active @endif" data-toggle="tab" href="#notification_{{ $not['branch_id'] }}" role="tab" aria-controls="trust" aria-selected="true">{{ $not['name'] }}
                                                <span style="margin-left:10px" class="label bg-danger">{{ count($not['data']) }}</span>
                                            </a>
                                        </li>
                                @endforeach
                                    ...
                                    {{-- @if ($current_user->branch_id != 3)
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                ...
                                                aria-selected="true">Uptown <span style="margin-left:10px" class="label bg-danger">{{ count($notification) }}</span></a></li>
                            ...
                            <div class="tab-content" style="max-height: 400px;overflow:scroll">
                                @foreach ($notifications as $not)
                                 ...
                                 <div class="tab-pane @if($current_user->branch_id == $not['branch_id']) active @endif"
                                    id="notification_{{$not['branch_id']}}" role="tabpanel">
                                    <table class="table table-striped table-bordered datatable">
                                        ...
                                        <tbody>
                                            @if (count($not['data']))
                                                @foreach ($not['data'] as $index => $notifi)
                        ...
                        <div class="card-body" style="width:100%;overflow-x:auto">
                            ...
                            <div class="row">
                                <div class="col-12" style="margin-bottom:50px;">
                                    ...
                                    <button class="btn btn-lg btn-success btn-submit  bulk-edit-mode  float-right"
                                    ...
                                    <button class="btn btn-lg btn-warning btn-submit  bulk-edit-mode  float-right" style="display:none"
                                        href="javascript:void(0)" onclick="saveBulkUpdate('INPROGRESS');" readonly>
                                ...
                                <div class="nav-tabs-custom nav-tabs-custom-ctr">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        @foreach ($branchs as $branch)
                                            <li class="nav-item">
                                                <a class="nav-link @if($current_user->branch_id == $branch->id) active @endif" data-toggle="tab" href="#branch_{{ $branch->id }}" role="tab" aria-controls="trust" aria-selected="true">
                                                    <span style="margin-left:10px" class="label bg-danger" id="span_voucher_count_{{ $branch->id }}">0</span> {{ $branch->name }}</a>
                                            </li>
                                        @endforeach
