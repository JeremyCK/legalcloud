        ...
        function addNewRow() {
            ...
            <tr id="row` + blockID + `">
                <td>
                    ...
                    <select class="form-control" name="accountCode" id="accountCode` + blockID + `">
                ...
                <td>
                    <input class="form-control " type="text" name="desc" id="desc` + blockID + `">
                </td>
                <td class="text-center">
                    <div class="checkbox">
                ...
                <td>
                    <input class="form-control number-decimal text-right" type="number" value="0"  onchange="convertDecimal('debit` +
                blockID + `',` + blockID + `,'spanDebit` + blockID + `')" name="debit" id="debit` + blockID +
                `">
                </td>
                <td>
                    <input class="form-control number-decimal text-right" type="number" value="0"   onchange="convertDecimal('credit` +
                blockID + `',` + blockID + `,'spanCrebit` +
                blockID + `')"  name="credit" id="credit` + blockID + `">
                </td>
                <td class="text-right">
                    RM <span    id="spanDebit` + blockID + `">0.00</span>
                </td>
                <td class="text-right">
                    RM <span id="spanCrebit` + blockID + `">0.00</span>
                </td>
                <td>
