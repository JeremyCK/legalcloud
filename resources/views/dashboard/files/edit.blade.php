            ...
            <div class="col-sm-12 col-md-10 col-lg-8 col-xl-12 ">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="form_adjudication" method="POST" action="{{ route('return-call.update', $main_obj->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="text" name="contact_no" value="{{$main_obj->contact_no}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="text" name="attention" value="{{$main_obj->attention}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="return_call">
                                                <option value="0"  @if($main_obj->return_call == 1) selected @endif>No</option>
                                                <option value="1"  @if($main_obj->return_call == 1) selected @endif>Yes</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>Enquiry </label>
                                            <textarea class="form-control" id="enquiry" name="enquiry" rows="3">{{$main_obj->enquiry}}</textarea>
                                        </div>
                                    </div>
                                </div>
