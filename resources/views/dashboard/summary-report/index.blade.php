                ...
                <table  id="tbl-summary-report"  class="table  table-bordered datatable" style="overflow-x: auto; width:100%">
                  ...
                  <tr class="text-center" style="background-color: black;color:white">
                    ...
                    <tr>
                      ...
                      <td class="text-center" style="font-size:9px" >{{ $quotation->case_ref_no }}</td>
                      <td class="text-right" style="font-size:9px" >{{ number_format($quotation->pfee1_recv, 2, '.', ',') }}</td>
                      <td class="text-right" style="font-size:9px" >{{ number_format($quotation->pfee2_recv, 2, '.', ',') }}</td>
