        ...
        function reloadTransferredTable() {
          ...
          name: 'DT_RowIndex'
                ...
                drawCallback: function(settings) {
                    ...
                    var span_total_amount = api.column(4).data().reduce(function(a, b) { return intVal(a) + intVal(b);}, 0);
                    var span_collected_amount = api.column(5).data().reduce(function(a, b) { return intVal(a) + intVal(b);}, 0);
                    var span_total_pfee = api.column(6).data().reduce(function(a, b) { return intVal(a) + intVal(b);}, 0);
                    var span_total_sst = api.column(7).data().reduce(function(a, b) { return intVal(a) + intVal(b);}, 0);
                    var span_total_pfee_to_transfer = api.column(8).data().reduce(function(a, b) { return intVal(a) + intVal(b);}, 0);
                    var span_total_sst_to_transfer = api.column(9).data().reduce(function(a, b) { return intVal(a) + intVal(b);}, 0);
                    var span_total_transferred_pfee = api.column(10).data().reduce(function(a, b) { return intVal(a) + intVal(b);}, 0);
                    var span_total_transferred_sst = api.column(11).data().reduce(function(a, b) { return intVal(a) + intVal(b);}, 0);
                    ...
                    $("#span_total_pfee_to_transfer").html(numberWithCommas(span_total_pfee_to_transfer.toFixed(2)));
                    $("#span_total_sst_to_transfer").html(numberWithCommas(span_total_sst_to_transfer.toFixed(2)));
                    $("#span_total_transferred_pfee").html(numberWithCommas(span_total_transferred_pfee.toFixed(2)));
                    $("#span_total_transferred_sst").html(numberWithCommas(span_total_transferred_sst.toFixed(2)));
