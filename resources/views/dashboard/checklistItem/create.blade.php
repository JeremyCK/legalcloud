                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <form id="form_new">
                                                        ...
                                                        <button class="btn btn-primary float-right" type="button" onclick="CreateNewChecklistStep()">Save</button>
                                                        <a class="btn btn-danger" href="{{ route('checklist-item.index') }}">Return</a>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
