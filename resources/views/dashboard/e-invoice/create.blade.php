                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" name="einvoice_date" id="einvoice_date"
                                                    type="date" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="pfee_only" name="pfee_only" value="1">
...
@section('javascript')
    ...
    <script>
        ...
        function SaveEinvoice() {
            ...
            if ($("#total_amount").val() == 0 || $("#transaction_id").val() == '' || $(
                    "#einvoice_date").val() == '') {
        ...
        function reloadAddTable() {
            console.log(JSON.stringify(transfer_fee_add_list));
