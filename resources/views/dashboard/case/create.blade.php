                            ...
                            <form method="POST" id="form_case"> 
                                ...
                                <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <select id="branch" class="form-control" name="branch" required>
                                                    @foreach ($Branchs as $index => $branch)
                                                        <option data-auto="{{ $branch->case_automation }}"
                                                            @if ($branch->id == $current_user->branch_id) selected @endif
                                    ...
                                    @if ($is_manual == 1)
                                                ...
                                                <div class="col">
                                                    ...
                                                    <select id="lawyer" class="form-control" name="lawyer">
                                                        ...
                                                        @foreach ($lawyers as $index => $lawyer)
                                                            ...
                                                            @endphp
                                                            <option chamber="1"
                                                                class="team_all branch_{{ $lawyer->branch_id }}  {{ $branch_list }}"
                                        ...
                                        @if(App\Http\Controllers\AccessController::UserAccessPermissionController(App\Http\Controllers\PermissionController::SelectSalesPermission()) == true)
                                        <div id="div_sales" class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                            <div class="form-group row">
                                                <div class="col">
                                                    <label>Sales</label>
                                                    ...
                                                    <select id="sales" class="form-control" name="sales">
                                                        <option value="0">-- Auto assign --</option>
                                                        @foreach ($sales_list as $index => $sales)
                                                        
                                                            <option 
                                                                class=" branch_{{ $sales->branch_id }}  "
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                        ...
                                        {{-- <div class="form-group row dCompany" style="display:none">
                                            <div class="col">
                                                <label><span class="text-danger">* </span>Company PIC</label>
                                                <input class="form-control" name="company_pic" type="text" required />
                                            </div>
                                        </div>

                                        <div class="form-group row dCompany" style="display:none">
                                            <div class="col">
                                                <label><span class="text-danger">* </span>Company PIC IC</label>
                                                <input class="form-control" name="company_pic_ic" type="text" required />
                                            </div>
                                        </div> --}}
                                    ...
                                    <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                ...
                                                <select id="case_type_select" class="form-control" name="bank" required>
...
@section('javascript')
    ...
    <script>
        ...
        function clientProfileCheck() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    $("#btnSubmit").attr("disabled", false);
                    $("#div_full_screen_loading").hide();
                    Swal.fire('Warning!', error['message'], 'error');
                }
            });
        }
        ...
        $(document).ready(function() {
            $('#case_type_select').select2({
                placeholder: "Select or type to search Case Type",
                allowClear: true,
                width: '100%'
            });
        });
