<div id="dInvoice-p" class="div2 invoice printableArea d_operation"
    ...
    <div class="row no-print" style="margin-bottom:30px;">
        ...
        <div class="col-12 div_inv_bill_to">
            <div class="row">
                <div class="col-6">
    ...
    <div class="row" style="border-bottom: 1px solid #0066CC ">
        ...
        <div class="col-4">
            @if (in_array($case->id, [1440]))
                <address class="print-formal">
                    <strong style="color: #2d659d">L H YEO & CO (Puchong)</strong><br>

                    <b>SST No:</b> B16-2209-37000001<br>
                    Advocates & Solicitors<br>
                    13, Jalan Puteri 1/4, Bandar Puteri, 47100 Puchong, Selangor<br>
                    <b>Phone</b>: 03-8051 5556 <b>Fax</b>: 03-8051 9556<br>
                    <b>Email</b>: legal@lhyeo.com
                </address>
            @elseif(in_array($case->id, [1612]))
                <address class="print-formal">
                    <strong style="color: #2d659d">L H YEO & CO (Arkadia)</strong><br>

                    <b>SST No:</b> B16-2209-38800003<br>
                    Advocates & Solicitors<br>
                    B-3A-23A, Ativo Plaza, Jalan PJU9/1, Damansara Avenue, <br>Bandar Sri Damansara PJU 9, 52200 KL<br>
                    <b>Phone</b>: 03-7727 1818 <b>Fax</b>: +603-6261 7896<br>
                    <b>Email</b>: lhyeodp@lhyeo.com
                </address>
            @elseif(in_array($case->id, [2296]))
                <address class="print-formal">
                    <strong style="color: #2d659d">L H YEO & CO (HQ)</strong><br>

                    <b>SST No:</b> B16-1808-31016330<br>
                    Advocates & Solicitors<br>
                    Unit 26-6, Oval Damansara, Jalan Damansara, 60000 Kuala Lumpur<br>
        ...
        <div class="col-4">
            <h2 class="text-center" style="position:absolute;bottom:0;right:0">
                <small class="pull-right">Date: <span id="print_payment_date_inv"></span> </small>
            </h2>
        </div>
    ...
    <div class="row invoice-info" style="margin-top:20px;">
        <div class="col-sm-12 invoice-col">
            <address>
                <b>To</b> <strong class="text-blue"><span id="p-quo-client-name-inv"></span></strong><br>
            </address>
        </div>
        ...
        <div class="col-sm-12 invoice-col">
            <div class="invoice-details row no-margin">
                ...
                <div class="col-md-6 col-lg-6 pull-right">
                    <span class="pull-right"><b>Invoice No: <span id="invoice_no"></span></b></span>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-12 table-responsive">
            <table class="table " id="tbl-print-invoice">
            </table>
        </div>
    </div>
