<div id="dInvoice-p" class="div2 invoice printableArea d_operation"
    ...
    <div class="row invoice-info" style="margin-top:20px;">
        <div class="col-6 invoice-col">
            {{-- <address>
                <b>To</b> <strong id="p-inv-client-name" class="text-blue">{{ $LoanCaseBillMain->invoice_to }}</strong><br>
            </address> --}}
        ...
        <div class="col-sm-12 invoice-col">
            <div class="invoice-details row no-margin">
                ...
                <div class="col-md-6 col-lg-6 pull-right">
                    <span class="pull-right"><b>Invoice No: {{ $LoanCaseBillMain->invoice_no }}</b></span>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr style="padding:0px !important;border: 1px solid black;padding-top:10px !important;">
                            ...
                            <td style="text-align:right;padding:0px !important;padding-right:10px !important;"
                                colspan="5"><b style="font-size:15px">
                                    {{ number_format((float) $total_SUM_Amt_SST, 2, '.', ',') }}</b></td>
