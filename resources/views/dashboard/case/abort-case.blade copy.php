            ...
            <div class="box-body no-padding " style="width:100%;overflow-x:auto">
              <div class="nav-tabs-custom nav-tabs-custom-ctr">
                <ul class="nav nav-tabs" role="tablist">
                  @if($current_user->menuroles == 'admin' || $current_user->menuroles == 'management' || $current_user->menuroles == 'account' || $current_user->menuroles == 'sales'|| $current_user->menuroles == 'chambering')
