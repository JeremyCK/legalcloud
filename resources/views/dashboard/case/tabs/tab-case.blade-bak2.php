            ...
            <li class="li-item-{{ $checkpoint_count1 }}">
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-footer text-right">
                  ...
                  <a id="btn_action_{{ $detail->id }}" href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="actionMode('{{ $detail->id }}', '{{ $cases[0]->id }}')"><i class="ion-compose"></i> Action</a>
                  @endif

                  @if($detail->close_case == 1)
                  <a id="btn_action_{{ $detail->id }}" href="javascript:void(0)" class="btn btn-warning btn-sm" onclick="closeCase('{{ $detail->id }}', '{{ $cases[0]->id }}')"><i class="ion-compose"></i> Close Case</a>
                  @endif
