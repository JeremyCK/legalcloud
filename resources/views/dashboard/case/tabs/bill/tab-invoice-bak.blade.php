        ...
        @if (App\Http\Controllers\AccessController::UserAccessPermissionController(App\Http\Controllers\PermissionController::AccessInvoicePermission()) == true)
            ...
            <table class="table mb-0">
                <tbody>
                    ...
                    <tr>
                        <td class="fw-medium"><b>Bill To</b> </td>
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu" style="padding:0">
                    ...
                    @php
                        ...
                        $targetDate = \Carbon\Carbon::parse('2024-05-22');
                    @endphp
                    ...
                    @endif
                             ...
                             @if (count($InvoiceBillingParty) > 0)
                                <a id="btn_split_invoice" class="dropdown-item " href="javascript:void(0)" data-backdrop="static"
                            data-keyboard="false" data-keyboard="false" data-toggle="modal"
                            data-target="#modalAddBillto"
                                onclick="SplitInvoiceMode();"
