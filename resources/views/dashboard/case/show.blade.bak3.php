    ...
    <div class="container-fluid">
        <div class="fade-in">
            ...
            <div class="row hide">
                ...
                <!-- /.col -->
                <div class="col-xl-3 col-md-6 col-12">
                    <a class="btn btn-primary nav-link " data-toggle="tab" href="#home" role="tab"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <h4 style="margin-bottom: 30px;">Accept new case</h4>

                                    @if ($current_user->menuroles == 'admin' || $current_user->menuroles == 'management')
                                        <div class="form-group row text-center">
                                            <label class="col-md-12 col-form-label text-warning">Accept this case as
                                                management role.</label>
                                            <div class="col-md-12">
    ...
    @endforeach
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                  <div class="form-group row">
                                    <div class="col">
                                      ...
                                      <textarea class="form-control" id="reason" name="reason" rows="3">{{ $cases[0]->remark }}</textarea>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="wizard-footer">
                                <div class="pull-right">
                                  <input type='button' class='btn btn-finish btn-fill btn-info btn-wd' onclick="setKIV('{{ $cases[0]->id }}')" value='KIV' />
                                  <input type='button' class='btn btn-finish btn-fill btn-danger btn-wd' onclick="acceptCase('{{ $cases[0]->id }}')" name='finish' value='Accept' />
                                </div>
                            ...
                            <form action="{{ route('case.update', $cases[0]->id) }}" method="POST">
                                ...
                                <div class="row text-center">
                                    <div class="col-sm-12">
                                        ...
                                        <img class="c-avatar-img" src="/assets/icons/coreui/ic_pending_lawyer.png"
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        @if ($current_user->menuroles == 'account' ||
                            ...
                            <li class="nav-item"><a class="nav-link " data-toggle="tab" href="#account_notes"
                                    role="tab" aria-controls="trust" aria-selected="true">Account Notes<span
                        ...
                        @if ($current_user->menuroles != 'account')
                            ...
                            <li class="nav-item"><a class="nav-link " data-toggle="tab" href="#documents"
                                    role="tab" aria-controls="document" aria-selected="true">Documents</a></li>
                        @endif
...
@section('javascript')
    ...
    <script>
        ...
        function trustDisburseMode(case_id) {
            ...
            $("#header-trust-entry").html('Create Disbursement');
       ...
       <tr id="row_bill_` + itemID + `">
            ...
            <td class="text-left available_number">RM ` + availableAmount + `<input id="txt_available_num_` + itemID +
                    ...
                    `" ></td>
            <td name="user_amount" ><input onclick="clearErrorHighlight()" onchange="convertDecimal('#txt_request_amt_` +
                    itemID +
      ...
      `;
        ...
        function generateVoucher(case_id) {
            ...
            $("#payee_voucher_name").val($("#txt_payee").val());
      ...
      `;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.status == 1) {
                        ...
                        if (data.cases[0].purchase_price != 0 && data.cases[0].purchase_price != '') {
                            $("#row_quo_purchase_price").show();
                            $("#lbl_quo_purchase_price").html("RM " + numberWithCommas(data.cases[0]
                                .purchase_price));
                        } else {
                            $("#row_quo_purchase_price").hide();
                        }

                        $("#lbl_purchase_price").html("RM " + numberWithCommas(data.cases[0].purchase_price));
                        $("#lbl_loan_sum").html("RM " + numberWithCommas(data.cases[0].loan_sum));
        ...
        function loadQuotationTemplate(case_id) {
            ...
            $.ajax({
                type: 'POST',
                url: '/load_quotation_template/' + $("#ddl_quotation_template").val(),
                data: formData,
                processData: false,
                contentType: false,
                success: function(data) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.invoice[0].account_details.length > 0) {
                        ...
                        let currentDate = new Date(data.invoice[0].account_details[0].created_at);
                    ...
                    // $("#sum_total_invoice").html(data.LoanCaseBillMain.total_amt);


                    $("#p-quo-client-name").html(data.client.name);
        ...
        function CreateBill(case_id) {
            ...
            var template_name = $("#ddl_quotation_template option:selected").text();
            ...
            form_data.append("quotation_template_id", $("#ddl_quotation_template").val());
        ...
        function submitNotesV1() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    Swal.fire('success', 'Notes updated', 'success')
                    location.reload();
                }
            });
        }
        ...
        function submitEditNotes() {
            ...
            $.ajax({
                type: 'POST',
                url: '/submitEditNotes/' + $("#note_edit_id").val(),
                // data: $('#form_notes').serialize(),
                data: formData,
                processData: false,
                contentType: false,
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Swal.fire('success', 'Notes deleted', 'success')
                            location.reload();
                        }
                    });
                }
