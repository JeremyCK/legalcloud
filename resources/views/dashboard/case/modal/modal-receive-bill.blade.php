<div id="modalReceiveBill" class="modal fade" role="dialog">
    <div class="modal-dialog" style="width: 80% !important;max-width: 80% !important;">
        ...
        <div class="modal-content">
            <div class="modal-header modal-header-print" style="display: block !important">
                <div class="row">
                    <div class="col-6">
                        <h4 class="card-title mb-0 flex-grow-1">Receive Bill Payment</h4>
                    </div>
                    <div class="col-6">
            ...
            <div class="modal-body">
                <div >
                    ...
                    <div class="card-body">
                        <form id="formBillReceive" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                              <div class="col-sm-6 col-md-10 col-lg-8 col-xl-12 ">
                                ...
                                <input class="form-control" type="hidden" name="bill_main_id" value="">
                      
                                <div class="form-group row">
                                  <label class="col-md-3 col-form-label" for="payment_name">Payee name <span class="text-danger">*</span></label>
                                  <div class="col-md-9">
                                    <input class="form-control" type="text" id="payment_name" name="payee" required>
                                  </div>
                                </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                    <input class="form-control" type="number" id="payment_amt" name="amount">
                                  </div>
                                </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                    <select class="form-control ddl_payment_type" name="payment_type" required>
                                ...
                                <div class="form-group row ">
                                  ...
                                  <div class="col-md-9">
                                    <select class="form-control" name="office_account_id" id="OfficeBankAccount_id" required>
