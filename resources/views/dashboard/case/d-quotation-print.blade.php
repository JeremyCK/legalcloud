...
<div id="dQuotationInvoice-p" title="test" class="div2 invoice printableArea d_operation "
    style="display: none;padding:30px;background-color:white !important; ">
    <title>quotation_{{ $case->case_ref_no }}</title>
    ...
    @foreach ($pieces as $index => $row)
        ...
        {{-- @include('dashboard.case.d-quotation-print-part', [
    ...
    {{-- @include('dashboard.case.d-quotation-print-part', ['LoanCaseBillMain' => $LoanCaseBillMain,
                                                       'current_user' => $current_user,
                                                       'quotation' => $quotation,
                                                       'case' => $case,
                                                       'Branch' => $Branch,
