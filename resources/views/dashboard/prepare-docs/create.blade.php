            ...
            <div class="col-sm-12 col-md-10 col-lg-8 col-xl-12 ">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="form_adjudication" method="POST" action="{{ route('prepare-docs.store') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="date" name="signing_date">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-10 col-lg-8 col-xl-6 ">
                                    <div class="form-group row">
                                        <div class="col">
                                            <label>Docs Prepared </label>
                                            <textarea class="form-control" id="docs_prepared" name="docs_prepared" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
