...
class DocTemplateFileController extends Controller
{
    ...
    {
        $documentTemplateFile = DocumentTemplateFile::all();

        return view('dashboard.genFileTest.index', ['documentTemplateFile' => $documentTemplateFile]);
    }
    ...
    public function getFile(Request $request)
    {
        ...
        $templatePath = public_path() . "/app/documents/templates/file_template_1/SPA_with_Title_PV_010122.docx";
