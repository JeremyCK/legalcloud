...
class CaseController extends Controller
{
    ...
    public function loadQuotationToInvoice($id)
    {
        ...
        $invoiceMainId = $loanCaseInvoiceMain->id;
        ...
        if (count($LoanCaseBillDetails) > 0) {
            for ($i = 0; $i < count($LoanCaseBillDetails); $i++) {
                ...
                $LoanCaseInvoiceDetails->invoice_main_id = $invoiceMainId;
        ...
        if ($request->input('NewAmount') != null) {
            ...
            if ($LoanCaseInvoiceDetails) {
                ...
                $LoanCaseInvoiceDetails->save();
                 ...
                 $party_count = InvoiceBillingParty::where('loan_case_main_bill_id', $LoanCaseInvoiceDetails->loan_case_main_bill_id)
                    ->count();

                LoanCaseInvoiceDetails::where('loan_case_main_bill_id', $LoanCaseInvoiceDetails->loan_case_main_bill_id)->update(['amount' => DB::raw('ori_invoice_amt /' . $party_count)]);    
