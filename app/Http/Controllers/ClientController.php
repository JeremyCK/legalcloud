...
class ClientController extends Controller
{
    ...
    public function index()
    {
        $account_template_cat = DB::table('voucher')
            ...
            ->select('voucher.*', 'loan_case.case_ref_no', 'loan_case_account.item_name', 'request.name AS request', 'approval.name AS approval')
            ->get();

        return view('dashboard.account.index', ['accounts' => $account_template_cat]);
    }
