...
class MasterlistController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.masterlist.index', ['caseMasterListField' => $caseMasterListField, 'caseMasterListCategory' => $caseMasterListCategory]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.banks.edit', ['banks' => $banks[0],
                                                'lawyers' => $lawyer, 
                                                'sales' => $sales, 
                                                'accounts' => $account, 
