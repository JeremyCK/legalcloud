...
class DispatchController extends Controller
{
    ...
    public function index()
    {
        ...
        if (in_array($current_user->menuroles, ['receptionist', 'account', 'sales', 'maker', 'lawyer', 'clerk'])) {
            $preparingCount = $preparingCount->whereIn('branch', $branchInfo['brancAccessList']);
            $deliveredCount = $deliveredCount->whereIn('branch', $branchInfo['brancAccessList']);
            $sendingCount = $sendingCount->whereIn('branch', $branchInfo['brancAccessList']);
        }
