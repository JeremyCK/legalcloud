...
class LoanCaseSeeder2 extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('loan_case')->insert([ 
            'case_ref_no' => 'A0/ZM/PBB/2/Ma/BB',
            'customer_id' => 2,
            'property_address' => 'A-17-00, Condo C, Selangor',
            'referral_name' => 'Mr Lim',
