...
class EmailTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('document_template_main')->insert([ 
            'name' => 'SPA Title',
            'code' => 'ST',
            'desc' => '',
            'status' => 1
        ...
        DB::table('document_template_details')->insert([ 
            'document_template_main_id' => 1,
        ...
        for($i = 0; $i<$numberOfpages; $i++){
            DB::table('document_template_pages')->insert([
                'document_template_details_id' => 1,
                'page' => $i + 1,
                'is_locked' => 0,
                'content' => 
                    '<!DOCTYPE html>
